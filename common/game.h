...
struct civ_game {
  ...
  union {
    ...
    struct {
      ...
      int techloss_restore_cost; /* gold cost of restoring tech */
      int techlost_donor;
      int techlost_recv;
      int tcptimeout;
      int techpenalty;
...
#define GAME_DEFAULT_TECHRESTCOST    0
#define GAME_MIN_TECHRESTCOST        0
#define GAME_MAX_TECHRESTCOST        1000
